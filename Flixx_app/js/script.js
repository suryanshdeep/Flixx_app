const global={
    ...
    api:{
        apikey:'6928254fccd42713e611399ed2bcba9f',
...
async function displayMovieDetails(){
    ...
    <div class="details-top">
        ...
        <div class="details-bottom">
          ...
          <div class="list-group">${movie.production_companies.map((c)=>`<span>${c.name}<\span>`).join(', ')}</div>
        </div>
    `;
    ...
    results.forEach((result)=>{
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            result.name}</h5>
            <p class="card-text">
              <small class="text-muted">Air Date: ${global.search.type ==='movie'?result.release_date:
...
function showAlert(message,className='error'){
    ...
    alertElm.classList.add('alert',className);
    alertElm.appendChild(document.createTextNode(message));
    document.querySelector('#alert').appendChild(alertElm);
    setTimeout(()=>{alertElm.remove()},3000);
}
